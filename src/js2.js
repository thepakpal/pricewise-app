...
V.settings = () => `${hdrG('Settings', 'Manage your account, notifications and accessibility')}<div class="scroll pad gap"><h3 class="cap">Preferences</h3><div class="bento2">${gtile('bell', 'blue', 'Notifications', 'notifs', '', 'Drops & recs', unread())}${gtile('eye', 'violet', 'Accessibility', 'access', '', 'Colour & text')}</div>
